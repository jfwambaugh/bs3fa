...
## Pre-demo steps (need to do this ahead of time)
# 1.) Download R and Rstudio 
# 2.) Install all of the three required libraries below
# 3.) Install bs3fa package

## Load required libraries -- may need to install each if not already done so
library(devtools) # e.g., if not installed, run install.packages("devtools")
library(ggplot2)
library(gridExtra)

## Install bs3fa package
...
# TRY ME
set.seed(12345) # set seed for random number generation (TRY ME! Change the seed!)
...
# TRY ME! Make prob_miss larger/smaller in [0,1):
#         - See how much missingness it takes to break the model.
...
# Display random three example unobserved curves
