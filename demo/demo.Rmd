...
```{r download-package, message=F, warning=F}
...
```{r model-display-the-pre-clean, fig.align='center', fig.height=2.75, fig.width=4.5, echo=F, warning=F}
...
\stackunder{X_i}{\sss S\times 1} =  \stackunder{\Theta}{\sss S\times K\text{ }}
\stackunder{\eta_i}{\sss K\times 1} + \stackunder{\Xi}{\sss S\times J\text{ }}
\stackunder{\nu_i}{\sss J\times 1} + \stackunder{\mathrm{e}_i}{\sss S\times 1}, \quad \stackunder{X_i}{\sss S\times 1} =  \stackunder{\Theta}{\sss S\times K\text{ }}
\stackunder{\eta_i}{\sss K\times 1} + \stackunder{\Xi}{\sss S\times J\text{ }}
\stackunder{\nu_i}{\sss J\times 1} + \stackunder{\mathrm{e}_i}{\sss S\times 1},
\end{equation*} \vfill
